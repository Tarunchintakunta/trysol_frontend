...
const UserDashboard = () => {
  ...
  return (
    <Container style={dashboardStyles.contentContainer}>
      ...
      {/* Row with Two Cards and Centered Lottie Animation */}
      <Row
        className="g-4"
      ...
      >
        <Col md={4} className="d-flex justify-content-center">
          <a
            ...
            style={{
              ...
              ...(hoveredCard === cards[0].id ? dashboardStyles.cardHover : {}),
            }}
            onMouseEnter={() => setHoveredCard(cards[0].id)}
            onMouseLeave={() => setHoveredCard(null)}
          >
            <div style={dashboardStyles.cardTitleOnly}>{cards[0].title}</div>
            {hoveredCard === cards[0].id && (
              <>
                <div style={{ ...dashboardStyles.cardDetails, opacity: 1 }}>
                  {cards[0].details}
                </div>
                <div style={{ ...dashboardStyles.cardFooter, opacity: 1 }}>
                  {cards[0].footer}
                </div>
              </>
            )}
        ...
        <Col md={4} className="d-flex justify-content-center">
          <a
            ...
            style={{
              ...dashboardStyles.card,
              ...(hoveredCard === cards[1].id ? dashboardStyles.cardHover : {}),
            }}
            onMouseEnter={() => setHoveredCard(cards[1].id)}
            onMouseLeave={() => setHoveredCard(null)}
          >
            <div style={dashboardStyles.cardTitleOnly}>{cards[1].title}</div>
            {hoveredCard === cards[1].id && (
              <>
                <div style={{ ...dashboardStyles.cardDetails, opacity: 1 }}>
                  {cards[1].details}
                </div>
